          ...
          <ul className="flex flex-col gap-3">
            <li className="flex items-center gap-2">
              ...
              <span className="text-sm text-zinc-400">
                ...
                <span className="text-zinc-100">08:35h</span>
              </span>
            </li>
            <li className="flex items-center gap-2">
              <CheckCircle2 className="size-4 text-pink-500" />
              <span className="text-sm text-zinc-400">
                Você completou "
                <span className="text-zinc-100">Nadar</span>" ás{" "}
                <span className="text-zinc-100">10:00h</span>
              </span>
            </li>
            <li className="flex items-center gap-2">
              <CheckCircle2 className="size-4 text-pink-500" />
              <span className="text-sm text-zinc-400">
                Você completou "
                <span className="text-zinc-100">Correr</span>" ás{" "}
